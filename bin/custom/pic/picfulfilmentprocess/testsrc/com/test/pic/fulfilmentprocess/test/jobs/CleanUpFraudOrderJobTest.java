 ...
 */
package com.test.pic.fulfilmentprocess.test.jobs;
...
import com.test.pic.fulfilmentprocess.jobs.CleanUpFraudOrderJob;
...
public class CleanUpFraudOrderJobTest extends ServicelayerTransactionalTest
{
	...
	private static final String PROCESS_DEFINITION_NAME = PicFulfilmentProcessConstants.ORDER_PROCESS_NAME;
