 ...
 */
package com.test.pic.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(PicFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(PicFulfilmentProcessConstants.PARENT_PROCESS);
