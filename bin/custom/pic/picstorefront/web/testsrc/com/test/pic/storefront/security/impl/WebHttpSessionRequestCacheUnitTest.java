...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/picstorefront/electronics/en",
						"https://electronics.local:9002/picstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/picstorefront/electronics/en",
						"https://electronics.local:9002/picstorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/picstorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/picstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/picstorefront/electronics/en",
						"https://electronics.local:9002/picstorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/picstorefront",
						"https://electronics.local:9002/picstorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/picstorefront",
						"https://electronics.local:9002/picstorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/picstorefront/electronics/en",
						"https://electronics.local:9002/picstorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
