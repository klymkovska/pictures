 ...
 */
package com.test.pic.test.setup;
...
import com.test.pic.test.constants.PicTestConstants;
import com.test.pic.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = PicTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/pictest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/pictest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/pictest/import/cstickets.impex");
			...
			importImpexFile(context, "/pictest/import/csquotes.impex");
		}
	}
}
